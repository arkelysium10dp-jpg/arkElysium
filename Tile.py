...
class Tile(Object):
    def __init__(self, surface: Surface, x, y, width_t, height_t, colour, is_draggable):
...
class GameTile(Tile):
    def __init__(self, surface: Surface, x, y, width_t, height_t, colour, is_draggable, is_placeable: bool):
