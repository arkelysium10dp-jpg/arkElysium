...
class Object:
    def __init__(self,surface, x, y,  anim, script = lambda a: None, hitbox: Hitbox = None):
        self.screen = surface
        self.anim = anim
        self.xy = [x, y]
        self.script = script
...
elysium_button = Tile(screen, 70, height-72,  70, 70, (215, 215, 215), True)

def elysium_button()

elysium_button.clicked =
